...
const Home = () => {
  ...
  return (
    <div className='Container' style={{ padding: '50px 10px', backgroundColor: 'gray' }}>
      ...
      // <p style={{ color: message.color, alignitems: message.alignitems,display: message.display}}>{message.messageerror}</p>) : (
        <DataTable
          columns={columns}
          data={records}
